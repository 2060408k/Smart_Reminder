...
public class NDWhereFragment extends Fragment {
    ...
    public NDWhereFragment() {}


    public static NDWhereFragment newInstance(EventType typeOfEvent) {
        NDWhereFragment fragment = new NDWhereFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_nd_where, container, false);
    ...
    private void prePopulateFields(){
        ...
        if (handler.getReminder().getLocation() != null) {
            eventTitleEditTxt.setText(handler.getReminder().getLocation());
        }
    }
    ...
    private void saveChoice(){
        String mLoc = eventTitleEditTxt.getText().toString();
