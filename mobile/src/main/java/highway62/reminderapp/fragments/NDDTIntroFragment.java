...
public class NDDTIntroFragment extends Fragment {
    ...
    public NDDTIntroFragment() {}


    public static NDDTIntroFragment newInstance() {
        return new NDDTIntroFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        apptBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mListener.loadFragmentHandler(HandlerType.ND, EventType.APPT);
            }
        });
        ...
        shopBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mListener.loadFragmentHandler(HandlerType.ND,EventType.SHOPPING);
            }
        });
        ...
        birthBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mListener.loadFragmentHandler(HandlerType.ND,EventType.BIRTH);
            }
        });
        ...
        medicBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mListener.loadFragmentHandler(HandlerType.ND,EventType.MEDIC);
            }
        });
        ...
        dailyBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mListener.loadFragmentHandler(HandlerType.ND,EventType.DAILY);
            }
        });
        ...
        socialBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mListener.loadFragmentHandler(HandlerType.ND,EventType.SOCIAL);
            }
        });
